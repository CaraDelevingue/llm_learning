...
def main():
    ...
    DATASET_DIR = os.path.join(ROOT_DIR,'model_service','data','processed')
    OUTPUT_DIR = os.path.join(ROOT_DIR,'models','output','training_output')
    SAVE_MODEL_DIR = os.path.join(ROOT_DIR,'models','output','trained_model')
